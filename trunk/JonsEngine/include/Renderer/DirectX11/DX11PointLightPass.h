...
namespace JonsEngine
{
    ...
    public:
		...
		void Render(const RenderablePointLight& pointLight, const Mat4& camViewMatrix, const Mat4& invCameraProjMatrix, const Vec2& screenSize, const float zFar, const float zNear);
