...
namespace JonsEngine
{
    ...
    struct Material
    {
        ...
        Material(const std::string& name, const TexturePtr& diffuseTexture, const Vec3& diffuseColor, const Vec3& ambientColor, const Vec3& specularColor, const Vec3& emissiveColor);
