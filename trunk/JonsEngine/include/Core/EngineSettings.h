...
namespace JonsEngine
{
    ...
    inline EngineSettings::EngineSettings() : mAnisotropicFiltering(0.0f),mWindowTitle("JonsEngine Game"), mWindowWidth(1920), mWindowHeight(1080), mFullscreen(false), mFOV(45.0f), mFrameLimit(0), mMSAA(0)
    {
    }
}