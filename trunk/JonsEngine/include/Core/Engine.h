...
namespace JonsEngine
{
    ...
    private:
        ...
        void CullMeshes(const ModelNode& node, const Mat4& viewProjectionMatrix, const Mat4& worldMatrix);
        void AddAllMeshes(const ModelNode& node, const Mat4& viewProjectionMatrix, const Mat4& worldMatrix);
