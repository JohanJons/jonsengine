...
namespace JonsEngine
{
    ...
    /* ConditionVariable inlines */
    inline const ConditionVariable::ConditionVariableState& ConditionVariable::GetConditionVariableState() const      { return mCondVarState; }
}