...
#define CBUFFER_SLOT_EXTRA_2 7
#define CBUFFER_SLOT_EXTRA_3 8
...
#define CBUFFER_REGISTER_EXTRA_2 b7
#define CBUFFER_REGISTER_EXTRA_3 b8
...
#define TEXTURE_SLOT_EXTRA_2 5
#define TEXTURE_SLOT_EXTRA_3 6
#define SBUFFER_SLOT_BONE_TRANSFORMS 7
#define SBUFFER_SLOT_EXTRA 8
#define SBUFFER_SLOT_EXTRA_2 9
#define SBUFFER_SLOT_EXTRA_3 10
...
#define TEXTURE_REGISTER_EXTRA_2 t5
#define TEXTURE_REGISTER_EXTRA_3 t6
#define SBUFFER_REGISTER_BONE_TRANSFORMS t7
#define SBUFFER_REGISTER_EXTRA t8
#define SBUFFER_REGISTER_EXTRA_2 t9
#define SBUFFER_REGISTER_EXTRA_3 t10

#define UAV_SLOT_0 0
#define UAV_SLOT_1 1
#define UAV_SLOT_2 2
#define UAV_REGISTER_0 u0
#define UAV_REGISTER_1 u1
#define UAV_REGISTER_2 u2
