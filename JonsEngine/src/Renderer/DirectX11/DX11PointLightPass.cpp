...
namespace JonsEngine
{
    ...
    void DX11PointLightPass::Render(const RenderQueue& renderQueue, const RenderablePointLight& pointLight, const Mat4& viewMatrix, const Mat4& invProjMatrix, const Vec2& screenSize, const float zFar, const float zNear)
    {
