...
namespace JonsEngine
{
    ...
    public:
		...
		TerrainID CreateTerrain(const std::string& name, float heightScale, uint32_t patchSize, float heightmapMultiplyer, SceneNodeID node, TerrainDataID terrainDataID);
