...
namespace JonsEngine
{
	...
	uint32_t RenderSettingsToVal( RenderSettings::TerrainPatchSize patchSizeEnum )
	{
		switch ( patchSizeEnum )
		{
			...
			case RenderSettings::TerrainPatchSize::X128: return 128;
			case RenderSettings::TerrainPatchSize::X256: return 256;
			case RenderSettings::TerrainPatchSize::X512: return 512;
		}
	}

	float RenderSettingsToVal( RenderSettings::TerrainPatchVerticeRatio vertexRatioEnum )
	{
		switch ( vertexRatioEnum )
		{
			default:
				JONS_ERROR( Logger::GetRendererLogger(), "DX11Utils::RenderSettingsToVal(RenderSettings::TerrainPatchVerticeRatio): Invalid enum" );
			case RenderSettings::TerrainPatchVerticeRatio::X0_5: return 0.5f;
			case RenderSettings::TerrainPatchVerticeRatio::X1: return 1.0f;
			case RenderSettings::TerrainPatchVerticeRatio::X1_5: return 1.5;
			case RenderSettings::TerrainPatchVerticeRatio::X2: return 2.0f;
		}
	}
