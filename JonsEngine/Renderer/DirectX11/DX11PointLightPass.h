...
namespace JonsEngine
{
    ...
    public:
        ...
        void Render( const RenderablePointLight& pointLight, const RenderData& renderData, const Mat4& camViewMatrix, const Mat4& camViewProjMatrix, const RenderSettings& renderSettings );
