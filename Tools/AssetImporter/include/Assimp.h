...
namespace JonsAssetImporter
{
    ...
    private:
        ...
        bool ProcessBones(std::vector<JonsEngine::PackageBone>& bones, std::vector<JonsEngine::PackageMesh>& meshes, const std::vector<JonsEngine::PackageNode>& nodes, const aiScene* scene);
