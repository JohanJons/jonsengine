...
namespace JonsEngine
{
    ...
    void DX11AmbientPass::Render(ID3D11DeviceContext* context, uint32_t screenWidth, uint32_t screenHeight)
    {
        ...
        mConstantBuffer.SetData(AmbientCBuffer(Vec2(screenWidth, screenHeight)), context, 0);
