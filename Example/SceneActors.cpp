...
namespace JonsGame
{
	...
	void SceneActors::Update()
	{
		mSun.Update();
	}

    void SceneActors::ToggleAnimationWuson()
    {
	...
	void SceneActors::ToggleAnimationBob()
	{
    ...
    JonsEngine::Scene& SceneActors::GetJonsScene()
    {
        return mSceneMgr.GetScene( mID );
    }

    JonsEngine::SceneNode& SceneActors::GetMovingLightNode()
    {
