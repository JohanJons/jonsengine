...
namespace JonsGame
{
	SceneTessellation::SceneTessellation( JonsEngine::DX11Renderer& renderer, JonsEngine::SceneManager& sceneMgr, JonsEngine::ResourceManifest& resManifest ) :
		...
		mTerrainDataTest( resManifest.CreateTerrainData( "terrainDataTest", "terrain_test", TextureType::Height8, mJonsPackage ) ),
		mTerrainData( resManifest.CreateTerrainData( "terraindata", "terrain_heightmap", TextureType::Height16, mJonsPackage ) ),
